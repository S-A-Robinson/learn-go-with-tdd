...
func TestPropertiesOfConversion(t *testing.T) {
	...
	assertThreeOrLessConsecutiveSymbols := func(arabic uint16) bool {
		if arabic > 3999 {
			return true
		}
	...
	if err := quick.Check(assertThreeOrLessConsecutiveSymbols, nil); err != nil {
		t.Error("failed checks", err)
	}
}
